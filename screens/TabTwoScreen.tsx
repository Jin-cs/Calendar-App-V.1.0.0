    ...
    return (
      <Fragment>
        ...
        <Calendar
          ...
          markedDates={{
            '2022-05-17': {disabled: true},
            '2022-05-08': {textColor: 'pink'},
            '2022-05-09': {textColor: 'pink'},
            '2022-05-14': {startingDay: true, color: 'green', endingDay: true},
            '2022-05-21': {startingDay: true, color: 'green'},
